# Don't Remove Credit Tg - @xazoc
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@ll_about_ari_ll
...
async def clone_menu(client, message):
    ...
    try:
        ...
        await msg.edit_text(f"⚠️ <b>Bot Error:</b>\n\n<code>{e}</code>\n\n**Kindly forward this message to @xazoc to get assistance.**")
